...
// Debug middleware DISABLED - was consuming request body and breaking Fedify
// TODO: Find a way to log inbox activities without consuming the body
// app.use("*", async (c, next) => {
//   const path = c.req.path;
//   const method = c.req.method;
//   if (method === "POST" && (path === "/inbox" || path.endsWith("/inbox"))) {
//     // Body logging was here but it broke inbox processing
//   }
//   await next();
// });
